...
/**
 * FakerCustomerServiceOptions to use in options form on BO
 * @class
 */
export default class FakerCustomerServiceOptions {
  ...
  /**
   * Constructor for class FakerCustomerServiceOptions
