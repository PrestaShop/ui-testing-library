import ContactMessageCreator from '@data/types/contactMessage';
 ...
 * @class
 */
export default class FakerContactMessage {
  ...
  /**
   * Constructor for class FakerContactMessage
   * @param messageToCreate {ContactMessageCreator} Could be used to force the value of some members
   */
  constructor(messageToCreate: ContactMessageCreator = {}) {
