...
import {HookModulePage as HookModulePageVersion} from '@versions/develop/pages/BO/design/positions/hookModule';
import type {Page} from 'playwright';

/**
 * Edit position page (legacy "Hook a module" form, before the hook_module_v2 Symfony migration),
 * contains functions that can be used on the page
 * @class
 * @extends HookModulePageVersion
 */
class HookModulePage extends HookModulePageVersion implements BODesignPositionsHookModulePageInterface {
  ...
  constructor() {
    ...
    // Selectors (legacy chosen widget form)
