import {type ShoppingCartDetails} from '@data/types/shoppingCart';
 ...
 * @extends BOBasePage
 */
class BOShoppingCarts extends BOBasePage implements BOShoppingCartsPageInterface {
...
module.exports = new BOShoppingCarts();
