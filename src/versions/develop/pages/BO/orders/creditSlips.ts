 ...
 * @extends BOBasePage
 */
class BOCreditSlipsPage extends BOBasePage implements BOCreditSlipsPageInterface {
   ...
   */
  async downloadCreditSlip(page: Page, row: number = 1): Promise<string|null> {
...
module.exports = new BOCreditSlipsPage();