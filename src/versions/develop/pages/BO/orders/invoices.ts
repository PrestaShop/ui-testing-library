 ...
 * @extends BOBasePage
 */
class BOInvoicesPage extends BOBasePage implements BOInvoicesPageInterface {
   ...
   * @returns {Promise<string|null>}
   */
  async generatePDFByStatusAndDownload(page: Page): Promise<string|null> {
...
module.exports = new BOInvoicesPage();
