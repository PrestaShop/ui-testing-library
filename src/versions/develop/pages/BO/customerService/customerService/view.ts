 ...
 * @extends BOBasePage
 */
class BOCustomerServiceViewPage extends BOBasePage implements BOCustomerServiceViewPageInterface {
   ...
   */
  async getBadgeNumber(page: Page): Promise<string> {
   ...
   * @returns {Promise<string>}
   */
  async getCustomerMessage(page: Page): Promise<string> {
   ...
   * @returns {Promise<string>}
   */
  async getThreadMessages(page: Page): Promise<string> {
   ...
   * @returns {Promise<string>}
   */
  async getAttachedFileHref(page: Page): Promise<string> {
   ...
   * @returns {Promise<string>}
   */
  async getOrdersAndMessagesTimeline(page: Page): Promise<string> {
    return this.getTextContent(page, this.ordersAndMessagesBlock);
  }
}

module.exports = new BOCustomerServiceViewPage();
