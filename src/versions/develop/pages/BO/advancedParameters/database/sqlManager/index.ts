 ...
 * @extends BOBasePage
 */
class BOSQLManagerPage extends BOBasePage implements BOSQLManagerPageInterface {
   ...
   */
  async exportSqlResultDataToCsv(page: Page, row: number = 1): Promise<string|null> {
...
module.exports = new BOSQLManagerPage();
