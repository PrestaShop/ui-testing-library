 ...
 * @extends BOBasePage
 */
class BODbBackupPage extends BOBasePage implements BODbBackupPageInterface {
   ...
   */
  async downloadDbBackup(page: Page): Promise<string|null> {
...
module.exports = new BODbBackupPage();
