import type FakerContact from '@data/faker/contact';
 ...
 * @extends BOBasePage
 */
class BOContactsCreatePage extends BOBasePage implements BOContactsCreatePageInterface {
...
module.exports = new BOContactsCreatePage();
