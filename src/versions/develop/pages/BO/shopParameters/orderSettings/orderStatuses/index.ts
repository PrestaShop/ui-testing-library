 ...
 * @extends BOBasePage
 */
class BOOrderStatusesPage extends BOBasePage implements BOOrderStatusesPageInterface {
   ...
   */
  async getTextColumn(page: Page, tableName: string, row: number, columnName: string): Promise<string> {
...
module.exports = new BOOrderStatusesPage();
