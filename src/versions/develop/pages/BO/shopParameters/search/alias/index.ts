...
class BOSearchAliasPage extends BOBasePage implements BOSearchAliasPageInterface {
  ...
  async sortTable(page: Page, sortBy: string, sortDirection: string): Promise<void> {
    ...
    const sortColumnDiv = `${this.sortColumnDiv(sortBySelector)}[data-sort-direction='${sortDirection}']`;
    const sortColumnSpanButton = this.sortColumnSpanButton(sortBySelector);
