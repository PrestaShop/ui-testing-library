...
import {type BOSeoUrlsCreatePageInterface} from '@interfaces/BO/shopParameters/trafficAndSeo/seoAndUrls/create';
 ...
 * @extends BOBasePage
 */
class BOSeoUrlsCreatePage extends BOBasePage implements BOSeoUrlsCreatePageInterface {
...
module.exports = new BOSeoUrlsCreatePage();
