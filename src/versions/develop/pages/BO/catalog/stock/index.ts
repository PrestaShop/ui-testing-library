 ...
 * @extends BOBasePage
 */
class BOStocksPage extends BOBasePage implements BOStockPageInterface {
   ...
   */
  async getStockQuantityForProduct(page: Page, row: number): Promise<{reserved: number, available: number, physical: number}> {
    return {
...
module.exports = new BOStocksPage();
