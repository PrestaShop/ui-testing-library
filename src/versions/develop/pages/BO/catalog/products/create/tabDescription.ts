...
/**
 * Description tab on new product page, contains functions that can be used on the page
 * @class
 * @extends BOBasePage
 */
...
const descriptionTab = new DescriptionTab();
export {descriptionTab, DescriptionTab};
