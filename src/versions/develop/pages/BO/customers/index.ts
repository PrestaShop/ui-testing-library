 ...
 * @extends BOBasePage
 */
class BOCustomersPage extends BOBasePage implements BOCustomersPageInterface {
   ...
   * @return {Promise<boolean>}
   */
  async setPartnerOffersStatus(page: Page, row: number, valueWanted: boolean = true): Promise<string | null | false> {
...
module.exports = new BOCustomersPage();
