 ...
 * @extends BOBasePage
 */
class BOCustomersViewPage extends BOBasePage implements BOCustomersViewPageInterface {
   ...
   * @returns {Promise<string>}
   */
  async deleteVoucher(page: Page, row: number): Promise<string> {
...
module.exports = new BOCustomersViewPage();
