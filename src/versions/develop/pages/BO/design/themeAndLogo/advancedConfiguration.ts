 ...
 */
class ThemeAdvancedCustomizationPage extends BOThemeAndLogoBasePage implements BOThemeAvancedConfigurationPageInterface {
...
module.exports = new ThemeAdvancedCustomizationPage();
