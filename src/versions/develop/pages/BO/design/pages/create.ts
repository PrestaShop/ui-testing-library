...
import {type BOCMSPagesCreatePageInterface} from '@interfaces/BO/design/pages/create';
 ...
 * @extends BOBasePage
 */
class BOCMSPagesCreatePage extends BOBasePage implements BOCMSPagesCreatePageInterface {
...
module.exports = new BOCMSPagesCreatePage();
