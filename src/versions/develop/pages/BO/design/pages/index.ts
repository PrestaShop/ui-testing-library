import {type BOCMSPagesPageInterface} from '@interfaces/BO/design/pages';
 ...
 * @extends BOBasePage
 */
class BOCMSPagesPage extends BOBasePage implements BOCMSPagesPageInterface {
  ...
  */
   ...
   * @return {Promise<string>}
   */
  async getTextColumnFromTableCmsPage(page: Page, row: number, column: string): Promise<string> {
   ...
   * @return {Promise<string>}
   */
  async getTextColumnFromTableCmsPageCategory(page: Page, row: number, column: string): Promise<string> {
   ...
   * @return {Promise<Array<string>>}
   */
  async getAllRowsColumnContentTableCmsPageCategory(page: Page, column: string): Promise<string[]> {
   ...
   */
  async getAllRowsColumnContentTableCmsPage(page: Page, column: string): Promise<string[]> {
...
module.exports = new BOCMSPagesPage();
