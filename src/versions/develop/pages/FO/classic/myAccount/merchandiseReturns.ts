 ...
 * @extends FOBasePage
 */
class MyMerchandiseReturnsPage extends FOBasePage implements FoMyMerchandiseReturnsPageInterface {
...
const myMerchandiseReturnsPage = new MyMerchandiseReturnsPage();
export {myMerchandiseReturnsPage, MyMerchandiseReturnsPage};
