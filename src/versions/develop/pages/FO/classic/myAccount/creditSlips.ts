 ...
 * @extends FOBasePage
 */
class FOMyCreditSlipsPage extends FOBasePage implements FOMyCreditSlipsPageInterface {
   ...
   * @return {Promise<string>}
   */
  async getCreditSlipID(page: Page, creditSlipRow: number = 1): Promise<string> {
   ...
   * @return {Promise<string>}
   */
  async getDateIssued(page: Page, creditSlipRow: number = 1): Promise<string> {
   ...
   */
  async getAlertInfoMessage(page: Page): Promise<string> {
