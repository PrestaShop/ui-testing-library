 ...
 * @extends FOBasePage
 */
class MyOrderDetailsPage extends FOBasePage implements FoMyOrderDetailsPageInterface {
   ...
   */
  async downloadInvoice(page: Page): Promise<string | null> {
   ...
   * @param page {Page} Browser tab
   */
  async isInvoiceVisible(page: Page): Promise<boolean> {
   ...
   */
  async isOrderReturnFormVisible(page: Page): Promise<boolean> {
...
const myOrderDetailsPage = new MyOrderDetailsPage();
export {myOrderDetailsPage, MyOrderDetailsPage};
