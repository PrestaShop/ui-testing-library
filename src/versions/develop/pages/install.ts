 ...
 * @extends CommonPage
 */
class InstallPage extends CommonPage implements InstallPageInterface {
  // Titles
   ...
   * @param page {Page} Browser Tab
   */
  async isThirdStepVisible(page: Page): Promise<boolean> {
   ...
   */
  async isInstallationInProgress(page: Page): Promise<boolean> {
   ...
   * @return {Promise<boolean>}
   */
  async isInstallationSuccessful(page: Page): Promise<boolean> {
