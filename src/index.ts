...
export {default as boEmployeeCreatePage} from '@pages/BO/advancedParameters/team/employees/create';
...
export {default as boRoleCreatePage} from '@pages/BO/advancedParameters/team/roles/create';
