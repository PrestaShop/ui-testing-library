...
export {default as boCreateProductPage} from '@pages/BO/catalog/products/create';
export {default as boCreateProductCombinationsTabPage} from '@pages/BO/catalog/products/create/combinationsTab';
export {default as boCreateProductDescriptionTabPage} from '@pages/BO/catalog/products/create/descriptionTab';
export {default as boCreateProductDetailsTabPage} from '@pages/BO/catalog/products/create/detailsTab';
export {default as boCreateProductOptionsTabPage} from '@pages/BO/catalog/products/create/optionsTab';
export {default as boCreateProductPackTabPage} from '@pages/BO/catalog/products/create/packTab';
export {default as boCreateProductPricingTabPage} from '@pages/BO/catalog/products/create/pricingTab';
export {default as boCreateProductSEOTabPage} from '@pages/BO/catalog/products/create/seoTab';
export {default as boCreateProductShippingTabPage} from '@pages/BO/catalog/products/create/shippingTab';
export {default as boCreateProductStocksTabPage} from '@pages/BO/catalog/products/create/stocksTab';
export {default as boCreateProductVirtualProductTabPage} from '@pages/BO/catalog/products/create/virtualProductTab';
