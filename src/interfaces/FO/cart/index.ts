...
export interface FoCartPageInterface extends FOBasePagePageInterface {
  ...
  readonly cartRuleCannotUseVoucherCountryDelivery: string;
  ...
  readonly errorNotificationForProductQuantity: (productQty: number) => string;
  readonly expiredDiscountErrorMessage: string;
  readonly minimumAmountErrorMessage: string;
  readonly noItemsInYourCartMessage: string;
  readonly notValidDiscountErrorMessage: string;
  readonly pageTitle: string;
  readonly VoucherNotWithTheseProductsErrorMessage: string;
