...
function requirePage(): BOLocalizationPageInterface {
  if (semver.lt(psVersion, '7.0.0')) {
    return require('@versions/1.6.1/pages/BO/localization/localization')
      .boLocalizationPage;
  }
  if (semver.lt(psVersion, '7.7.0')) {
    return require('@versions/1.7.6/pages/BO/international/localization')
      .boLocalizationPage;
  }
  if (semver.lt(psVersion, '7.8.0')) {
    return require('@versions/1.7.7/pages/BO/international/localization')
      .boLocalizationPage;
  }
